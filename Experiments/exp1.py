...
def plot1(data_sizes, alphabet_size=10, missingness_parameter=0.1, dl="me", minsup=1):
    ...
    for data_size in data_sizes:
        ...
        while learned_theory == None:
            ...
            learned_theory, _ = mistle.learn(dl_measure=dl, minsup=minsup)
...
def plot3(alphabet_sizes, data_size=400, missingness_parameter=0.1, dl="me", minsup=1):
    similarity_list = []
