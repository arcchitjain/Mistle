...
#     mistle_prune_compression_list,
#     marker="o",
#     label="Mistle (with pruning)",
# )
# plt.ylim(bottom=0, top=1.05)
# # plt.legend(bbox_to_anchor=(0, -0.2), loc="upper left", ncol=3)
...
# plt.figure(2)
# plt.ylabel("Compression\n(DL: Modified Entropy)")
# plt.xlabel("Proportion of literals missing from data")
...
# )
# plt.plot(
#     noise_list, mistle_prune_compression_list, marker="o", label="Mistle (with pruning)"
# )
#
# plt.ylim(bottom=0, top=1.05)
# plt.legend(bbox_to_anchor=(0, -0.2), loc="upper left")
...
#         },
#     )
#     mistle_w_compression_list.append(compression1)
#
#     mistle = Mistle([], negatives)
#     _, compression2 = mistle.learn(
#         dl_measure=dl,
#         minsup=support,
#         lossy=False,
#         prune=False,
...
#         },
#     )
#     mistle_w_s_compression_list.append(compression2)
#
#     mistle = Mistle([], negatives)
#     _, compression3 = mistle.learn(
#         dl_measure=dl, minsup=support, lossy=False, prune=False, mining_steps=1
#     )
#     mistle_all_compression_list.append(compression3)
#
#
# plt.figure(7)
# plt.ylabel("Compression\n(DL: Modified Entropy)")
...
#     mistle_w_s_compression_list,
#     marker="o",
#     label="Mistle (only W and S operators)",
# )
# plt.plot(
#     negative_size_list,
#     mistle_all_compression_list,
#     marker="o",
#     label="Mistle (only lossless operators)",
# )
#
# plt.ylim(bottom=0, top=1.05)
# plt.legend(bbox_to_anchor=(0, -0.2), loc="upper left")
...
#
# plt.plot(noise_list, mining4sat_compression_list, marker="o", label="Mining4SAT")
# plt.plot(noise_list, mistle_w_compression_list, marker="o", label="Mistle - W operator")
# plt.plot(
#     noise_list, mistle_w_s_compression_list, marker="o", label="Mistle - S, W operators"
# )
# plt.plot(
#     noise_list,
#     mistle_all_compression_list,
#     marker="o",
#     label="Mistle - R, S, W operators",
# )
#
# plt.ylim(bottom=0, top=1.05)
# plt.legend(bbox_to_anchor=(0, -0.2), loc="upper left")
